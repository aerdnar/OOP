...
public class Food {
	...
	private SortedMap<String, NutritionalElement> productsMap = new TreeMap<>();
	private SortedMap<String, NutritionalElement> recipesMap = new TreeMap<>();
	...
	public void defineRawMaterial(String name, double calories, double proteins, double carbs, double fat) {
		materials.put(name, new RawMaterial(name, calories, proteins, carbs, fat));
	}
	...
	public Collection<NutritionalElement> rawMaterials() {
		/*
		 * if(changed==true){ ((List<NutritionalElement>) materials).sort((a,b)
		 * -> a.getName().compareTo(b.getName())); changed=false; } return
		 * materials;
		 */
	...
	public NutritionalElement getRawMaterial(String name) {
		/*
		 * for(NutritionalElement elem : materials)
		 * if(elem.getName().equals(name)) return elem; return null;
		 */
	...
	public void defineRecipe(String name, Recipe recipe) {
